...
AsInfo_Panel::AsInfo_Panel()
	: Extra_Lives_Count(AsConfig::Initial_Life_Count), Dark_Blue(0, 170, 170), Dark_Red(151, 0, 0), 
	  ...
	  Expecting_User_Name(true), Start_Tick(0)
{
	Logo_Rect.left = Score_X * AsConfig::Global_Scale;
	Logo_Rect.top = 5 * AsConfig::Global_Scale;
	Logo_Rect.right = Logo_Rect.left + 104 * AsConfig::Global_Scale;
	Logo_Rect.bottom = Logo_Rect.top + 100 * AsConfig::Global_Scale;

	Data_Rect.left = Score_X * AsConfig::Global_Scale;
	Data_Rect.top = Score_Y * AsConfig::Global_Scale;
	Data_Rect.right = Data_Rect.left + Score_Width * AsConfig::Global_Scale;
	Data_Rect.bottom = Data_Rect.top + Score_Height * AsConfig::Global_Scale;
