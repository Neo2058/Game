...
private:
	...
	void Delete_Objects(vector<AGraphics_Object*>& falling_letters);
	void Act_Objects(vector<AGraphics_Object*>& falling_letters);
	...
	vector<AGraphics_Object *> Active_Bricks;
	vector<AGraphics_Object *> Falling_Letters;
	vector<APoint> Teleport_Bricks_Pos;
	AAdvertisement *Advertisement;
	vector<ALevel_Data *> Levels_Data;
	AsMop Mop; //Швабра
	AsLevel_Title Level_Title; //Табличка уровня
