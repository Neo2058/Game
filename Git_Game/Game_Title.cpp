...
void AsGame_Title::Show(bool game_over)
{
	...
	if (game_over)
	{
		...
		Title_Letters.push_back(new AFinal_Letter(title_x, title_y, L'Ê'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 13.0, title_y, L'Î'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 29.0, title_y, L'Í'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 45.0, title_y, L'Å'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 59.0, title_y, L'Ö'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 80.0, title_y, L'È'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 96.0, title_y, L'Ã'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 109.0, title_y, L'Ð'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 121.0, title_y, L'Û'));
	...
	else
	{
		...
		Title_Letters.push_back(new AFinal_Letter(title_x, title_y, L'Ï'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 16.0, title_y, L'Î'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 33.0, title_y, L'Á'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 46.0, title_y, L'Å'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 59.0, title_y, L'Ä'));
		Title_Letters.push_back(new AFinal_Letter(title_x + 75.0, title_y, L'À'));
