...
public:
	...
	static const int Hits_Per_Letter = 50;  // Вероятность выбить букву = 1.0 / Hits_Per_Letter
	...
	static const int Max_Mop_Indicator_Fade_Step = FPS * 4 / 10; //0.4 секунды для индикатора
...
private:
	...
	vector<AHit_Checker *> Hit_Checkers;
};
//------------------------------------------------------------------------------------------------------------
